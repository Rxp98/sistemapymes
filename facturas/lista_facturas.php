                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo number_format($factura['monto_descuento_nota_credito'], 0, ',', '.'); ?></td>
                                        ...
                                        <td>
                                            <center>
                                            <a href="editar_factura.php?id=<?php echo $factura['id_factura']; ?>" class="btn btn-warning">Editar</a>
                                            <a href="eliminar_facturas.php?id=<?php echo $factura['id_factura']; ?>" class="btn btn-danger">Eliminar</a>
